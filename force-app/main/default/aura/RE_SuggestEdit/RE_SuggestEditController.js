({
    doInit : function(component, event, helper) {
        ...
        var statusobj=[];
        statusobj.push({ Name:$A.get("$Label.c.address"), Id: "Address"});
       // statusobj.push({ Name: "Facility Conditions", Id: "Facility Conditions"});
      //  statusobj.push({ Name: "Facility Staff", Id: "Facility Staff"});
        statusobj.push({ Name: $A.get("$Label.c.RE_Hours"), Id: "Hours"});
        statusobj.push({ Name: $A.get("$Label.c.RE_Phone_Email"), Id: "Phone/Email"});
        statusobj.push({ Name: $A.get("$Label.c.Other"), Id: "Other"});
